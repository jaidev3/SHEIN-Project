...
C1vishnuMinus.onclick=function(){
    if(C1vishnuValue.value>1){
        ...
        if(C1temp==0){
            ...
            C1FreeShip.textContent='Buy US$'+(49-C1temp)+' more to enjoy FREE STANDARD SHIPPING!'
        }else{
        ...
        if(C1temp==0){
            C1disc.textContent='Spend US$69 to be eligible for discounts, you currently need US$69 more to be eligible.';            
        }else if(C1temp<69){
            C1disc.textContent='Spend US$69 to be eligible for discounts, you currently need US$'+(69-C1temp)+' more to be eligible.';
        }else{
            
                C1disc.textContent="Your total amount qualifies for Discounts!!🎉🎉🎉😍😍";
...
function C1vishnuAddBtn(idVal,num){   
    ...
    if(num==1)
    C1vishnuAdd2.style.backgroundColor='grey';
    else
    C1vishnuAdd2.style.backgroundColor='black';
}
